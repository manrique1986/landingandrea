...
const Primero = () => {
  return (
    <div
      ...
      style={{ backgroundImage: "url('https://res.cloudinary.com/dytpump6i/image/upload/v1743547329/Disen%CC%83o_sin_ti%CC%81tulo_26_um7edn.png')" }}
    >
          ...
          <div className="mt-6 text-center sm:text-left p-4">
            <div className="flex flex-wrap justify-center sm:justify-start lg:gap-8">
              <ul className="font-[var(--font-poppins)] text-xs sm:text-base grid grid-cols-2 gap-4 sm:gap-8">
                <li className="flex items-center gap-2"><FaCircle className="text-[#911ba2] text-xs" /> ESTRATEGIA de captación personalizada</li>
                <li className="flex items-center gap-2"><FaCircle className="text-[#911ba2] text-xs" /> PUBLICIDAD OPTIMIZADA en Meta, Google y LinkedIn ads</li>
                <li className="flex items-center gap-2"><FaCircle className="text-[#911ba2] text-xs" /> OPTIMIZACIÓN DE PERFIL en redes</li>
                <li className="flex items-center gap-2"><FaCircle className="text-[#911ba2] text-xs" /> CREATIVOS de alto impacto</li>
                <li className="flex items-center gap-2"><FaCircle className="text-[#911ba2] text-xs" /> AUTOMATIZACIÓN de gestión de clientes</li>
                <li className="flex items-center gap-2"><FaCircle className="text-[#911ba2] text-xs" /> REPORTES y ANÁLISIS de resultados</li>
                <li className="flex items-center gap-2"><FaCircle className="text-[#911ba2] text-xs" /> PLANTILLAS de respuesta para ventas</li>
                <li className="flex items-center gap-2"><FaCircle className="text-[#911ba2] text-xs" /> SEGUIMIENTO y AJUSTES semanales</li>
              </ul>
            </div>
          </div>
        </div>
