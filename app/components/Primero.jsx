...
const Primero = () => {
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center sm:items-start justify-center w-full max-w-[100%] sm:w-3/5 p-6 sm:p-8 rounded-lg sm:pl-16">
          ...
          <div className="mt-6 text-center sm:text-left p-4">
            <div className="flex flex-wrap justify-center sm:justify-start gap-8">
              <div className="w-full sm:w-auto ">
                <ul className="space-y-2 font-[var(--font-poppins)] text-xs sm:text-base grid grid-cols-2 sm:gap-8 sm:space-y-0">
